...
Date: 11/28/2023
Descp:Make 2 separate blank word files with text, "This is a test.". Open them in a C program as a binary file and compare the contents. Are the 2 files equal?
*/
#include <stdlib.h>
